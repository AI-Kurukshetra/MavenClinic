...
export default async function ProviderPatientDetailPage({
  ...
  try {
    ...
    console.error("Provider patient detail page error:", error);
    return <PageErrorState title="Unable to load patient chart" message="Please refresh the page to try again." href="/provider/patients" />;
  }
}
